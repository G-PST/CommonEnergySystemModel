...
Before starting, complete the xref:installation.adoc[Installation Guide] (including generating Pydantic classes from the schema).
All scripts below are run from the repository root with the virtual environment activated.
