...
IMPORTANT: Always use a virtual environment. Installing CESM and its dependencies into your global Python is not recommended -- it can cause version conflicts with other projects.
