...
class StartupMethod(str, Enum):
    ...
    linear = "linear"
    """
    Online variable is continuous
    """
    integer = "integer"
    """
    Online variable is discrete
    """
...
class HasFlow(ConfiguredBaseModel):
    ...
    flow_annual: Optional[float] = Field(default=None, description="""Annual flow that can be used to scale the flow profile. Always positive - flow_profile defines the direction.""", json_schema_extra = { "linkml_meta": {'annotations': {'qudt.ucum_code': {'tag': 'qudt.ucum_code', 'value': '[MW.h]'},
         ...
         'domain_of': ['HasFlow']} })
    flow_profile: Optional[Any] = Field(default=None, description="""Flow profile that can be scaled by flow_annual. Positive values are inflow and negative values outflow from the node.""", json_schema_extra = { "linkml_meta": {'annotations': {'qudt.ucum_code': {'tag': 'qudt.ucum_code', 'value': '[1]'},
...
class Storage(HasInvestments, HasPenalty, HasFlow, Node):
    ...
    storage_loss_from_stored_energy: Optional[float] = Field(default=None, description="""Loss of stored energy over one hour as a fraction of the energy stored.""", json_schema_extra = { "linkml_meta": {'annotations': {'qudt.ucum_code': {'tag': 'qudt.ucum_code',
                                            'value': '[10*-2]'},
                         'qudt_unit': {'tag': 'qudt_unit', 'value': 'unit:PERCENT'}},
         'domain_of': ['Storage']} })
    flow_annual: Optional[float] = Field(default=None, description="""Annual flow that can be used to scale the flow profile. Always positive - flow_profile defines the direction.""", json_schema_extra = { "linkml_meta": {'annotations': {'qudt.ucum_code': {'tag': 'qudt.ucum_code', 'value': '[MW.h]'},
...
class Unit(HasInvestments, Entity):
    ...
    conversion_rates: Optional[Union[ConversionRatesFloatFloat, float]] = Field(default=None, description="""Multiplier(s) for turning inputs to outputs or for transferring between nodes. Can be given as single float (constant efficiency) or as a list of tuples where first value is for operating point and second value is for efficiency. The list must have decreasing values for the operating points - starting from 100%.""", json_schema_extra = { "linkml_meta": {'annotations': {'qudt.ucum_code': {'tag': 'qudt.ucum_code',
                                            'value': '[10*-2]'},
                         'qudt_unit': {'tag': 'qudt_unit', 'value': 'unit:PERCENT'}},
         'any_of': [{'range': 'float'},
                    {'multivalued': True, 'range': 'ConversionRatesFloatFloat'}],
         'domain_of': ['Unit', 'Link']} })
    availability: Optional[float] = Field(default=None, description="""Time series for availability (to represent forced outages).""", json_schema_extra = { "linkml_meta": {'annotations': {'qudt.ucum_code': {'tag': 'qudt.ucum_code',
                                            'value': '[10*-2]'},
                         'qudt_unit': {'tag': 'qudt_unit', 'value': 'unit:PERCENT'}},
    ...
    units_existing: Optional[Union[PeriodFloat, float]] = Field(default=None, description="""Number of pre-existing conversion units at the model start.""", json_schema_extra = { "linkml_meta": {'annotations': {'qudt.ucum_code': {'tag': 'qudt.ucum_code', 'value': '[1]'},
         ...
         'any_of': [{'range': 'float'}, {'range': 'PeriodFloat'}],
         'domain_of': ['Unit']} })
    startup_cost: Optional[float] = Field(default=None, description="""Cost of one full startup for one unit.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Unit'], 'is_a': 'currency_per_unit'} })
    investment_method: Optional[InvestmentMethod] = Field(default=None, description="""Choice of investment method.""", json_schema_extra = { "linkml_meta": {'domain_of': ['HasInvestments']} })
    discount_rate: Optional[Union[PeriodFloat, float]] = Field(default=None, description="""Discount rate of the investment.""", json_schema_extra = { "linkml_meta": {'annotations': {'qudt.ucum_code': {'tag': 'qudt.ucum_code',
                                            'value': '[10*-2]'},
                         'qudt_unit': {'tag': 'qudt_unit', 'value': 'unit:PERCENT'}},
...
class Port(HasProfiles, Entity):
    ...
    constraint_flow_coefficient: Optional[ConstraintFloat] = Field(default=None, description="""Multiplier between constraints and the flow. Map of constraints and respective coefficients.""", json_schema_extra = { "linkml_meta": {'annotations': {'qudt.ucum_code': {'tag': 'qudt.ucum_code', 'value': '[1]'},
                         'qudt_unit': {'tag': 'qudt_unit', 'value': 'unit:UNITLESS'}},
         'domain_of': ['Port']} })
    inertia_constant: Optional[float] = Field(default=None, description="""Inertia constant for a synchronously connected unit to this node.""", json_schema_extra = { "linkml_meta": {'annotations': {'qudt.hasFactorUnit': {'tag': 'qudt.hasFactorUnit',
                                                'value': '- hasUnit: unit:MegaW-s, '
                                                         'exponent: 1\n'
                                                         '- hasUnit: unit:MegaW, '
                                                         'exponent: -1\n'},
                         'qudt.ucum_code': {'tag': 'qudt.ucum_code',
                                            'value': '[MWs/MW]'}},
         'domain_of': ['Port']} })
    profile_limit_upper: Optional[list[float]] = Field(default=[], json_schema_extra = { "linkml_meta": {'annotations': {'qudt.ucum_code': {'tag': 'qudt.ucum_code', 'value': '[1]'},
                         'qudt_unit': {'tag': 'qudt_unit', 'value': 'unit:UNITLESS'}},
...
class ConversionRatesFloatFloat(ConfiguredBaseModel):
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'from_schema': 'file:///cesm.yaml'})

    operating_point: Optional[float] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['ConversionRatesFloatFloat']} })
    conversion_rate: Optional[float] = Field(default=None, json_schema_extra = { "linkml_meta": {'domain_of': ['ConversionRatesFloatFloat']} })
...
ConversionRatesFloatFloat.model_rebuild()
