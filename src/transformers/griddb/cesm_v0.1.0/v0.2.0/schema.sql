-- DISCLAIMER
-- Schema v0.2.0 - Updated to match rts_psy5.sqlite GridDB structure
...
-- Table of possible entity types (SiennaOpenAPIModels types)
CREATE TABLE entity_types (name text PRIMARY KEY);

-- Populate entity types with SiennaOpenAPIModels component types
INSERT INTO entity_types VALUES
    ('SiennaOpenAPIModels.HydroDispatch'),
    ('SiennaOpenAPIModels.TwoTerminalGenericHVDCLine'),
    ('SiennaOpenAPIModels.HydroPumpTurbine'),
    ('SiennaOpenAPIModels.FixedAdmittance'),
    ('SiennaOpenAPIModels.RenewableNonDispatch'),
    ('SiennaOpenAPIModels.ThermalStandard'),
    ('SiennaOpenAPIModels.HydroTurbine'),
    ('SiennaOpenAPIModels.RenewableDispatch'),
    ('SiennaOpenAPIModels.HydroReservoir'),
    ('SiennaOpenAPIModels.InterruptiblePowerLoad'),
    ('SiennaOpenAPIModels.EnergyReservoirStorage'),
    ('SiennaOpenAPIModels.Arc'),
    ('SiennaOpenAPIModels.Transformer2W'),
    ('SiennaOpenAPIModels.StandardLoad'),
    ('SiennaOpenAPIModels.ThermalMultiStart'),
    ('SiennaOpenAPIModels.MonitoredLine'),
    ('SiennaOpenAPIModels.TapTransformer'),
    ('SiennaOpenAPIModels.ACBus'),
    ('SiennaOpenAPIModels.Area'),
    ('SiennaOpenAPIModels.PowerLoad'),
    ('SiennaOpenAPIModels.Line'),
    ('SiennaOpenAPIModels.LoadZone'),
    ('SiennaOpenAPIModels.AreaInterchange'),
    ('SiennaOpenAPIModels.PhaseShiftingTransformer');
...
-- Populate prime mover types with EIA codes
...
-- Populate fuels with standardized fuel types
...
CREATE TABLE storage_units (
    ...
    name text NOT NULL,
    prime_mover text NOT NULL REFERENCES prime_mover_types(name),
    -- Energy capacity (nullable in v0.2.0)
    max_capacity real,
    balancing_topology integer NOT NULL REFERENCES balancing_topologies (id),
...
-- Trigger to ensure entity exists before inserting planning_regions
CREATE TRIGGER check_planning_regions_entity_exists BEFORE
